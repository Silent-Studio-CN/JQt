...
$clArgs = @(
    ...
    "/I", (Join-Path $QtRoot "include\QtOpenGLWidgets"),
    "/I", (Join-Path $QtRoot "include\QtOpenGL"),
    ...
    (Join-Path $QtRoot "lib\Qt6OpenGLWidgets.lib"),
    (Join-Path $QtRoot "lib\Qt6OpenGL.lib"),
