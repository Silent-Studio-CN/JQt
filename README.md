...
| 头像 | 贡献者 | 角色 |
|------|--------|------|
| <img src="assets/deepseek-2.svg" width="64" alt="DeepSeek-Work-In-SilentStudio"/> | **DeepSeek-Work-In-SilentStudio** (@SilentServerAC) | AI 开发（提交署名，GitHub 账号头像；`.mailmap` 映射全部历史提交） |
