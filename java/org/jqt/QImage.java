 ...
 * <p>完整覆盖 Qt 6 QImage 常用 API，核心价值：{@link #fromBufferedImage(BufferedImage)} /
 * {@link #toBufferedImage()} 与 Java AWT 图像生态互转。
 */
public class QImage {
    ...
    // ---- Java 生态桥 ----
    public static QImage fromBufferedImage(BufferedImage bi) {
