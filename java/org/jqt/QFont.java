 ...
 * <p>完整覆盖 Qt 6 QFont 常用 API，并提供 {@link #fromAwt(java.awt.Font)} / {@link #toAwt()}
 * 与 Java AWT 字体生态互转（family/pointSize/bold/italic 映射）。
 */
public class QFont {
    ...
    // ---- Java 生态桥 ----
    /** 从 java.awt.Font 构造（family/pointSize/bold/italic 映射）。 */
    public static QFont fromAwt(java.awt.Font f) {
        return new QFont(f.getFamily(), f.getSize(),
                         f.isBold() ? Weight.Bold.value : Weight.Normal.value, f.isItalic());
    }
    ...
    public java.awt.Font toAwt() {
        ...
        int size = pointSize() > 0 ? pointSize() : 12;
        return new java.awt.Font(family() != null ? family() : "Dialog", style, size);
    }
